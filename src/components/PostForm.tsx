        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5 max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              placeholder="e.g., iPhone 13 Pro with clear case"
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="block w-full px-3 py-2.5 bg-slate-900 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
              placeholder="e.g., Times Square, Metro Entrance,Sobhanbag lab"
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              placeholder="Describe color, model, brands, or any distinct stickers, scratches, lockscreens that can verify ownership! Your report will undergo admin approval."
          ...
          <div className="p-3 bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 text-[11px] rounded-xl flex items-start space-x-2">
            ...
            <p className="text-slate-300">
              All reported items are set as <strong>"Pending"</strong> initially. An Admin will review and approve your listing shortly before it is broadcasted.
            </p>
          </div>
