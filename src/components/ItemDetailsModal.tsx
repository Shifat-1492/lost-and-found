...
import { X, MapPin, Calendar, MessageSquare, AlertCircle, Trash2, Mail, User2, LogIn } from 'lucide-react';
            ...
            <div className="flex items-center space-x-3 justify-end">
              {showConfirmDelete ? (
                ...
                <>
                  ...
                  {/* Start Chat — guests prompted to log in; owners don't see this */}
                  {!isOwner && (
                    currentUser ? (
                      <button
                        type="button"
                      ...
                      <button
                        ...
                        className="px-6 py-2.5 bg-linear-to-r from-slate-700 to-slate-600 hover:from-indigo-600 hover:to-violet-700 text-white font-semibold rounded-xl focus:outline-hidden hover:shadow-md hover:shadow-indigo-500/20 transition-all text-sm flex items-center space-x-2 cursor-pointer border border-indigo-500/40"
                      >
